...
candidate_options = []
# { "Candidate Name": Num_Votes}
candidate_votes = {}

# 1: Create a county list and county votes dictionary.
county_list = []
# { "County Name": Num_Votes}
county_votes = {}
...
with open(file_to_save, "w") as txt_file:
    ...
    for county in county_votes:
        ...
        county_result = (
            f"{county}: {county_percentage:.1f}% ({vote_count:,})\n"
        )
        ...
        if (vote_count > largest_county_turnout) and (county_percentage > largest_county_percentage):
            largest_county = county
            largest_county_turnout = vote_count
